...
ecosystem_section=f'''
<section class="section ecosystem" id="ecosystem"><div class="wrap">
<div class="ecosystem-intro"><div><p class="eyebrow">Gachon CCL × Flower</p><h2>Built with Flower.<br><span>Extended by Gachon CCL.</span></h2></div><div class="ecosystem-copy"><p>We contribute reusable Flower Apps and evaluate federated fine-tuning on FlowerTune’s public leaderboards.</p>{external('https://flower.ai/apps','Explore Flower Apps','text-link')}</div></div>
<div class="contribution-switcher" aria-label="Flower contributions"><button type="button" aria-pressed="true" aria-controls="flower-hub-card">Flower Hub</button><button type="button" aria-pressed="false" aria-controls="flower-tune-card">FlowerTune</button></div>
<div class="contribution-grid">
<article class="contribution-card" id="flower-hub-card"><div class="contribution-head"><span>01 / FLOWER HUB</span><h3>Apps others can reuse.</h3><p>@gfedops publishes federated workloads for the Flower community.</p></div>
<dl class="contribution-metrics"><div><dt>Created Apps</dt><dd>{flower_profile["created_apps"]}</dd></div><div><dt>Total Stars</dt><dd>{flower_profile["total_stars"]}</dd></div></dl>
<div class="contribution-tabs" role="tablist" aria-label="Flower Hub app examples"><button id="hub-tab-mnist" role="tab" aria-selected="true" aria-controls="hub-panel" tabindex="0" data-image="/assets/hub-mnist.jpg" data-title="FedOps MNIST Client App" data-link="https://flower.ai/apps/gfedops/fedops-mnist">MNIST Client</button><button id="hub-tab-multimodal" role="tab" aria-selected="false" aria-controls="hub-panel" tabindex="-1" data-image="/assets/hub-multimodal.webp" data-title="FedOps Multimodal" data-link="https://flower.ai/apps/gfedops/fedops-multimodal">Multimodal FL</button></div>
<figure class="contribution-preview" id="hub-panel" role="tabpanel" aria-labelledby="hub-tab-mnist" tabindex="0"><img class="contribution-image" src="/assets/hub-mnist.jpg" alt="Flower Hub page for the FedOps MNIST Client App" width="1400" height="788" loading="lazy"><figcaption><b class="contribution-title">FedOps MNIST Client App</b><a class="contribution-source" href="https://flower.ai/apps/gfedops/fedops-mnist" target="_blank" rel="noopener noreferrer">View app <span aria-hidden="true">↗</span><span class="sr-only"> (opens in a new tab)</span></a></figcaption></figure>
<div class="contribution-footer">{external(flower_profile['url'],'See all @gfedops apps')}</div></article>
<article class="contribution-card" id="flower-tune-card"><div class="contribution-head"><span>02 / FLOWERTUNE</span><h3>Results anyone can check.</h3><p>Gachon CCL’s federated fine-tuning results on public leaderboards.</p></div>
<dl class="contribution-metrics"><div><dt>General NLP</dt><dd>Rank 02</dd></div><div><dt>Medical</dt><dd>Rank 04</dd></div></dl>
<div class="contribution-tabs" role="tablist" aria-label="FlowerTune leaderboard results"><button id="tune-tab-nlp" role="tab" aria-selected="true" aria-controls="tune-panel" tabindex="0" data-image="/assets/leaderboard-nlp.webp" data-title="General NLP leaderboard" data-link="https://flower.ai/benchmarks/llm-leaderboard/nlp">General NLP</button><button id="tune-tab-medical" role="tab" aria-selected="false" aria-controls="tune-panel" tabindex="-1" data-image="/assets/leaderboard-medical.webp" data-title="Medical leaderboard" data-link="https://flower.ai/benchmarks/llm-leaderboard/medical">Medical</button></div>
<figure class="contribution-preview" id="tune-panel" role="tabpanel" aria-labelledby="tune-tab-nlp" tabindex="0"><img class="contribution-image" src="/assets/leaderboard-nlp.webp" alt="FlowerTune General NLP leaderboard with Gachon Cognitive Computing Lab result" width="1400" height="788" loading="lazy"><figcaption><b class="contribution-title">General NLP leaderboard</b><a class="contribution-source" href="https://flower.ai/benchmarks/llm-leaderboard/nlp" target="_blank" rel="noopener noreferrer">View results <span aria-hidden="true">↗</span><span class="sr-only"> (opens in a new tab)</span></a></figcaption></figure>
<div class="contribution-footer">{external('https://flower.ai/benchmarks/llm-leaderboard','Explore FlowerTune')}</div></article>
</div><p class="contribution-note">Flower pages captured September 2026 · App counts and stars as of {flower_profile["checked_on"]}. Open each source for current results.</p>
</div></section>
'''
hero_diagram=(ROOT/'work/hero-diagram.html').read_text(encoding='utf-8')
home=f'''
<section class="hero"><div class="wrap"><div class="hero-grid"><div><p class="eyebrow light">Federated AI AgentOps Platform</p><h1>Build Agents.<br><span>Federate Intelligence.</span><br>Improve Continuously.</h1><p class="lead"><strong>FedOps 1.3</strong> connects local AI development, federated learning, versioned model assets, and Agent delivery in one governed lifecycle. Organizations learn together while raw data remains under each participant’s control.</p><div class="actions"><a class="button primary" href="/document/getting-started/">Get Started <span aria-hidden="true">→</span></a>{external(CONSOLE,'FedOps Console','button secondary')}</div></div>{hero_diagram}</div></div></section>
{why_section}
