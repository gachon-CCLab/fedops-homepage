...
'''
home=f'''
<section class="hero"><div class="wrap"><div class="hero-grid"><div><p class="eyebrow light">Federated AI AgentOps Platform</p><h1>Build Agents.<br><span>Federate Intelligence.</span><br>Improve Continuously.</h1><p class="lead"><strong>FedOps 1.3</strong> connects local AI development, federated learning, versioned model assets, and Agent delivery in one governed lifecycle. Organizations learn together while raw data remains under each participant’s control.</p><div class="actions"><a class="button primary" href="/document/getting-started/">Get Started <span aria-hidden="true">→</span></a>{external(CONSOLE,'FedOps Console','button secondary')}</div></div><div class="lifecycle-diagram" role="img" aria-label="FedOps lifecycle: publish a Task and Release, train locally with Agent Studio and the FL Server, then version the Global Model and build an Agent."><div class="lifecycle-heading"><strong>Federated AI Lifecycle</strong><span>FedOps 1.3</span></div><div class="lifecycle-node lifecycle-wide"><small>FedOps Web · Registry</small><b>Publish Task &amp; Release</b><p>Define participation and track model versions.</p></div><div class="lifecycle-arrow" aria-hidden="true">↓</div><div class="lifecycle-middle"><div class="lifecycle-node"><small>Agent Studio</small><b>Train locally</b><p>Data stays local</p></div><span class="lifecycle-swap" aria-hidden="true">↔</span><div class="lifecycle-node"><small>FL Server</small><b>Aggregate</b><p>Coordinate rounds</p></div></div><div class="lifecycle-arrow" aria-hidden="true">↓</div><div class="lifecycle-node lifecycle-outcome"><small>Versioned Outcome</small><b>Global Model <span aria-hidden="true">→</span> Agent Build &amp; Serving</b></div></div></div></div></section>
{why_section}
