...
<div class="contribution-tabs" role="tablist" aria-label="Flower Hub app examples"><button id="hub-tab-mnist" role="tab" aria-selected="true" aria-controls="hub-panel" tabindex="0" data-image="/assets/hub-mnist.webp" data-title="FedOps MNIST XAI" data-link="https://flower.ai/apps/gfedops/fedops-mnist-xai">MNIST + XAI</button><button id="hub-tab-multimodal" role="tab" aria-selected="false" aria-controls="hub-panel" tabindex="-1" data-image="/assets/hub-multimodal.webp" data-title="FedOps Multimodal" data-link="https://flower.ai/apps/gfedops/fedops-multimodal">Multimodal FL</button></div>
<figure class="contribution-preview" id="hub-panel" role="tabpanel" aria-labelledby="hub-tab-mnist" tabindex="0"><img class="contribution-image" src="/assets/hub-mnist.webp" alt="Flower Hub page for the FedOps MNIST XAI app" width="1400" height="788" loading="lazy"><figcaption><b class="contribution-title">FedOps MNIST XAI</b><a class="contribution-source" href="https://flower.ai/apps/gfedops/fedops-mnist-xai" target="_blank" rel="noopener noreferrer">View app <span aria-hidden="true">↗</span><span class="sr-only"> (opens in a new tab)</span></a></figcaption></figure>
